...
import co.com.gsdd.knowledgedb.constants.GeneralConstants;

@SpringBootApplication
@ComponentScan({ GeneralConstants.REPO_PKG, GeneralConstants.CONTROLLER_PKG, GeneralConstants.SERV_PKG,
		GeneralConstants.CONF_PKG, GeneralConstants.COMP_PKG })
